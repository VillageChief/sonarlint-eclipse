...
public class RuleExclusionsPage extends PropertyPage implements IWorkbenchPreferencePage {
  ...
  public void init(IWorkbench workbench) {
    setDescription("Configure rules to be excluded from SonarLint analysis. When a project is connected to a CodeScan server, configuration from the server apply.");
